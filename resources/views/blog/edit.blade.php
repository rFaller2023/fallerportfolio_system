        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" name="image" id="image" value="{{$blog->image}}" class="form-control" placeholder="Image">
                    @error('image')
                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="content" id="content" value="{{$blog->content}}" class="form-control" placeholder="Content">
                    @error('content')
                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
